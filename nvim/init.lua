...
require('lazy').setup('kickstart.plugins.lazy', {
  ui = {
...
-- Apply syntax highlighting in the quickfix window
vim.api.nvim_create_autocmd('FileType', {
  pattern = 'qf',
  group = 'QuickfixColors',
  callback = function()
    vim.cmd 'syntax clear' -- Clear existing syntax highlighting
    vim.cmd 'syntax match ErrorMsg /\\v(ERROR|error|failed)/ containedin=.*'
    vim.cmd 'syntax match WarningMsg /\\v(WARNING|Warning|warn|warning)/ containedin=.*'
    vim.cmd 'syntax match SuccessMsg /\\v(passed|ok|success|SUCCESS)/ containedin=.*'
    vim.cmd 'highlight link ErrorMsg Error'
    vim.cmd 'highlight link WarningMsg WarningMsg'
